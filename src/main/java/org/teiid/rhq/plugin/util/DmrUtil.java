...
//			ASConnection connection, String name,
...
//			ASConnection connection, ComponentType componentType,
...
//	 * @throws Exception
//	 */
//	public static Set<ManagedComponent> getManagedComponents(ASConnection connection,
...
//	 * @throws Exception
//	 */
//	public static DeploymentManager getDeploymentManager(ASConnection connection)
//			throws NamingException, Exception {
//
//		return null; //connection.getDeploymentManager();
//	}
//
//	/**
//	 * @return {@link File}
...
//	 *             , Exception
//	 */
//	public static File getDeployDirectory(ASConnection connection) throws NamingException, Exception {
...
//		return null; //deployDir;
//	}
//
//	public static ManagedComponent getRuntimeEngineDeployer(
//			ASConnection connection) throws NamingException,
//			Exception {
//
...
//	}
//
//	public static final String stringValue(MetaValue v1) throws Exception {
//		if (v1 != null) {
...
//	}
	...
	public static Address getTeiidAddress() {
		Address addr = new Address(TeiidExtension.TEIID_SUBSYSTEM);
		addr.add("subsystem", TeiidExtension.TEIID_SUBSYSTEM);
		return addr;
	}
